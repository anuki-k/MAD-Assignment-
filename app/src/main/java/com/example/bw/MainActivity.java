...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    private static void onAuthStateChanged(FirebaseAuth firebaseAuth) {
        // Get signedIn user
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        authStateListener = MainActivity::onAuthStateChanged;
        GoogleSignInOptions.Builder builder = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN);
        builder.requestIdToken(getString(R.string.web_client_id));
        builder.requestEmail();//you can also use R.string.default_web_client_id
